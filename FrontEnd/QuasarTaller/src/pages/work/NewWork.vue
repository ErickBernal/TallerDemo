<template>
  ...
  <q-page class="q-pa-md">
    ...
    <q-btn
      @click="toggleTable"
      label="Modificar servicios disponibles"
      color="primary"
    />
    <!-- Tabla oculta hasta que se presione el botón -->
...
const filteredRows = computed(() => {
  return rows.value.filter(
    (row) =>
      row.work.toLowerCase().includes(filterText.value.toLowerCase()) ||
      row.priceWork
        .toString()
        .toLowerCase()
